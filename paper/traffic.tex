...
For future work we would like to apply our algorithms not only to life traffic but also to predicted traffic, e.g. find smooth paths in a time-dependent setting.
