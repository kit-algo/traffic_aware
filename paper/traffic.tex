...
\caption{
TODO
% TODO explain perf profile
}\label{fig:perf_profile}
\end{figure}

Figure~\ref{fig:perf_profile} depicts performance profiles for running time and found path length off all queries from Table~\ref{tab:data} combined.
