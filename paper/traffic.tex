...
On continental-sized road networks with tens of millions of vertices and edges, CH preprocessing typically takes a few minutes.
...
Here, we introduce an algorithm which can compute exact UBS values of typical paths with a few shortest path queries.
